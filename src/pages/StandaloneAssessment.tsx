...
import { MapPin, Plus, Trash2, Save, LogOut, List } from 'lucide-react'
      ...
      <div className="bg-white shadow-sm border-b sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-gray-800">Field Assessment</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="sticky bottom-0 bg-white border-t shadow-lg p-4 flex gap-3 justify-end">
            <button
              type="submit"
              disabled={loading}
              className="flex-1 sm:flex-none px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 flex items-center justify-center gap-2 font-medium shadow-md"
            >
