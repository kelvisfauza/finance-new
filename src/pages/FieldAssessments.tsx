...
import { Plus, MapPin, Calendar, User, Eye } from 'lucide-react'
...
export default function FieldAssessments() {
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold">Field Assessments</h1>
          <p className="text-gray-600">Market intelligence and crop assessment records</p>
        </div>
        <button
          onClick={() => navigate('/field-assessment/new')}
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-sm font-semibold">Team Members</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold">Farmers</th>
                  <th className="px-4 py-3 text-left text-sm font-semibold">Crop Condition</th>
                  ...
                  <tr key={assessment.id} className="hover:bg-gray-50">
                    <td className="px-4 py-3 text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        {new Date(assessment.visit_date).toLocaleDateString()}
                      </div>
                    </td>
                    <td className="px-4 py-3 text-sm">
                      <div className="font-medium">{assessment.area_village}</div>
                      {assessment.district && (
                        <div className="text-xs text-gray-500">{assessment.district}</div>
                      )}
                    </td>
                    <td className="px-4 py-3 text-sm">
                      <div className="flex items-center gap-2">
                    ...
                    <td className="px-4 py-3 text-sm">
                      <div>Visited: {assessment.farmers_visited}</div>
                      <div className="text-xs text-green-600">New: {assessment.new_suppliers_identified}</div>
                    </td>
                    <td className="px-4 py-3 text-sm">
                      <span
